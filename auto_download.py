...
command = 'rm -rf /home/sykesj/raw/fastq_dump_cache/sra/*.sra* ; rm -rf  /home/sykesj/dat/fastq_dump_cache/sra/*.sra* ; rm -rf /home/sykesj/busco_*.log ; rm -rf /projects/sykesj/raw/*' + species + '*; rm -rf /projects/sykesj/analyses/*' + species + '*; rm -rf /scratch/projects/sykesj/*' + species + '*'
