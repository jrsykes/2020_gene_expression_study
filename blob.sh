...
# Creating a blobDB  
blobtools create -i /projects/sykesj/analyses/$SPECIES/trinity/$LAYOUT"_assembly_1k.fa" -t /projects/sykesj/analyses/$SPECIES/blast/$SPECIES"_blastn_"$LAYOUT"_sorted.out" -o blobplot -c /projects/sykesj/analyses/$SPECIES/kallisto/$SRR".cov"

# Extracting a "view" table
blobtools view -i blobplot.blobDB.json --rank all --hits
