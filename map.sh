...
kallisto_map () {
	...
	then
		...
		/exports/software/kallisto/kallisto_linux-v0.43.1/kallisto quant -t 16 -i /projects/sykesj/analyses/$SPECIES/kallisto/paired_$SPECIES.idx -o /scratch/projects/sykesj/map_$SRR/$SRR -b 100 \
