...
########### paired ###########
		...
		/home/sykesj/software/trinityrnaseq-v2.9.1/Trinity --SS_lib_type RF --seqType fq --left $LEFT --right $RIGHT --CPU 30 --max_memory 100G --output \
			...
			rsync -a /scratch/projects/sykesj/trinity_"$SPECIES"_"$LAYOUT"/Trinity.fasta /projects/sykesj/analyses/"$SPECIES"/trinity/paired_assembly.fa && \
...
###### filter out < 1000 bp ##########
		...
		python3 /home/sykesj/scripts/2020_gene_expression_study/1k_filter.py /projects/sykesj/analyses/"$SPECIES"/trinity/paired_assembly.fa \
			/projects/sykesj/analyses/"$SPECIES"/trinity/"$LAYOUT"_assembly_1k.fa && rm -f /projects/sykesj/analyses/"$SPECIES"/trinity/paired_assembly.fa
...
###### busco ##########
		...
		python /home/sykesj/software/busco-master/src/busco/run_BUSCO.py -f --config /home/sykesj/software/busco-master/config/config.ini -i \
			/projects/sykesj/analyses/"$SPECIES"/trinity/paired_assembly_1k.fa -o busco_"$LAYOUT"_"$SPECIES" \
			-l arthropoda_odb10 -m tran -c 16 \
			&& mv /scratch/projects/sykesj/BUSCO_tmp/busco_paired_"$SPECIES"/short_summary.specific.arthropoda_odb10.busco_paired_"$SPECIES".txt \
...
########## blast ##########
		...
		/home/sykesj/software/ncbi-blast-2.10.0+/bin/blastn -task megablast -query /projects/sykesj/analyses/$SPECIES/trinity/paired_assembly_1k.fa -db nt -outfmt '6 qseqid staxids bitscore std' \
			...
			&& sort -k 13,13 -n /projects/sykesj/analyses/"$SPECIES"/blast/blastn_paired_"$SPECIES".out > /projects/sykesj/analyses/"$SPECIES"/blast/"$SPECIES"\_blastn_"$LAYOUT"_sorted.out \
...
########### single ############
		...
		/home/sykesj/software/trinityrnaseq-v2.9.1/Trinity --seqType fq --single "$INPUT" --CPU 30 --max_memory 100G --output /scratch/projects/sykesj/trinity_"$SPECIES"_"$LAYOUT"q && \
			rsync -a /scratch/projects/sykesj/trinity_"$SPECIES"_"$LAYOUT"/Trinity.fasta /projects/sykesj/analyses/"$SPECIES"/trinity/single_assembly.fa && \
			rm -rf /scratch/projects/sykesj/trinity_"$SPECIES"_"$LAYOUT"*
...
###### filter < 1000 bp ##########
		...
		python3 /home/sykesj/scripts/2020_gene_expression_study/1k_filter.py /projects/sykesj/analyses/"$SPECIES"/trinity/single_assembly.fa \
			/projects/sykesj/analyses/"$SPECIES"/trinity/"$LAYOUT"_assembly_1k.fa && rm -f /projects/sykesj/analyses/"$SPECIES"/trinity/single_assembly.fa

###### busco ##########

		python /home/sykesj/software/busco-master/src/busco/run_BUSCO.py -f --config /home/sykesj/software/busco-master/config/config.ini -i \
			/projects/sykesj/analyses/"$SPECIES"/trinity/single_assembly_1k.fa -o busco_"$LAYOUT"_"$SPECIES" \
			-l arthropoda_odb10 -m tran -c 16 \
			&& mv /scratch/projects/sykesj/BUSCO_tmp/busco_single_"$SPECIES"/short_summary.specific.arthropoda_odb10.busco_single_"$SPECIES".txt \
			/projects/sykesj/analyses/"$SPECIES"/busco/BUSCO_out_"$SPECIES"_"$LAYOUT".txt \
...
########## blast ##########
		...
		/home/sykesj/software/ncbi-blast-2.10.0+/bin/blastn -task megablast -query /projects/sykesj/analyses/"$SPECIES"/trinity/single_assembly_1k.fa -db nt -outfmt '6 qseqid staxids bitscore std' \
			...
			&& sort -k 13,13 -n /projects/sykesj/analyses/"$SPECIES"/blast/blastn_"$LAYOUT"_"$SPECIES".out > /projects/sykesj/analyses/"$SPECIES"/blast/blastn_"$LAYOUT"_"$SPECIES"_sorted.out \
